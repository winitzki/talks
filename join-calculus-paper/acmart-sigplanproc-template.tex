...
%% Supplied to authors by publisher for camera-ready submission
\acmConference[SBTB'17]{Scale by the Bay 2017}{November 15-18, 2017}{San Francisco, USA}
\acmYear{2017}
\acmISBN{ISBN not assigned}
\acmPrice{0.00}
\acmDOI{DOI not assigned}
\startPage{1}
\fi
...
\affiliation{
  ...
  \department{SYMAN team}              %% \department is recommended
...
for unit testing, thread pool control, and fault tolerance. I show
how \texttt{Chymyst} embeds such features in the JC paradigm.
\end{abstract}
