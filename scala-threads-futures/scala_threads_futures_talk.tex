...
(\texttt{\textcolor{blue}{\small{}map}}, \texttt{\textcolor{blue}{\small{}flatMap}})
use implicit \texttt{\textcolor{blue}{\small{}ExecutionContext}}{\small \par}
\end{itemize}
\end{frame}
...
\texttt{\textcolor{blue}{\small{}val f:~Future{[}Boolean{]}}} \\
\textendash{} represents a \texttt{\textcolor{blue}{\small{}Boolean}}
value that \emph{will} \emph{become available} in the future
