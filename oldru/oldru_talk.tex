...
\begin{itemize}
\item Omit the mute ``e'' in endings, replace vowels to ``simplify''

\begin{itemize}
\item some $\rightarrow$ sum, made $\rightarrow$ maid, gate $\rightarrow$
gait, breathe $\rightarrow$ breath
\end{itemize}
...
\begin{itemize}
\item because they are ``a heritage of the horrible old times'' 
\end{itemize}
\end{itemize}
\end{itemize}
\end{frame}
...
\item Reprinting each old book is hard work for editors
\end{itemize}
\item In Russia:
...
\selectlanguage{russian}%
\begin{itemize}
\item есть - ѣсть, нежить - нѣжить, миръ - міръ, некогда - нѣкогда
\end{itemize}
\selectlanguage{english}%
...
\begin{itemize}
\item identifying part of speech
\item identifying inflection (number, gender, case)
\item for some words, even identifying semantic content
