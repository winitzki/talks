...
\begin{itemize}
\item Became part of \texttt{xfonts-cyrillic}
\end{itemize}
...
\begin{frame}{The KOI8-C encoding and screen fonts in Netscape}


Viewing Nabokov, \emph{Despair} (1934)

\includegraphics[scale=0.5]{xcyr-screenshot}
\end{frame}
...
\includegraphics[scale=0.5]{oldrus-screenshot}
\end{frame}
