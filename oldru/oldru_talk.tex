...
\begin{itemize}
\item Replaced \foreignlanguage{russian}{ѣ$\rightarrow$е, ѳ$\rightarrow$ф,
...
\item No\emph{ }computers today support the old Russian orthography 
\end{itemize}
\end{itemize}
\end{frame}
...
\end{itemize}
\item No keyboard layouts, no screen fonts, few vector fonts had 
