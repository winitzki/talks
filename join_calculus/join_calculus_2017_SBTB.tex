...
\institute[Workday, Inc.]{Scale by the Bay}
...
\item Example:\\
~\\
\texttt{\textcolor{blue}{\scriptsize{}go \{ f(x, replyToF) + c(y)
$\Rightarrow$ replyToF(x + y) \}}}~\\
\texttt{\textcolor{blue}{\scriptsize{}c(100)}}\textrm{\textcolor{gray}{\footnotesize{}
// non-blocking}}\texttt{\textcolor{blue}{\scriptsize{}}}~\\
\texttt{\textcolor{blue}{\scriptsize{}val result = f(200)}}\textrm{\textcolor{gray}{\footnotesize{}
// blocking, will get 300}}{\footnotesize \par}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Industry-strength features
...
\item \href{https://github.com/winitzki/talks/blob/master/join_calculus/join_calculus_2017_SBTB.pdf}{Talk slides}
\end{itemize}
\end{frame}
