...
Implement Future with blocking poll (``\texttt{\textcolor{blue}{\scriptsize{}get}}''):\\
...
f51}}{\scriptsize \par}
\begin{lyxcode}
\textsf{\textcolor{gray}{\footnotesize{}//~...~some~definitions~omitted~for~brevity}}{\footnotesize \par}

\textcolor{blue}{\scriptsize{}site~(}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~t1(\_)~$\Rightarrow$~wait();~h1()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~t2(\_)~$\Rightarrow$~wait();~h2()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~t3(\_)~$\Rightarrow$~wait();~h3()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~t4(\_)~$\Rightarrow$~wait();~h4()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~t5(\_)~$\Rightarrow$~wait();~h5()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~h1(\_)~+~f12(\_)~+~f51(\_)~$\Rightarrow$~wait();~t1()~+~f12()~+~f51()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~h2(\_)~+~f23(\_)~+~f12(\_)~$\Rightarrow$~wait();~t2()~+~f23()~+~f12()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~h3(\_)~+~f34(\_)~+~f23(\_)~$\Rightarrow$~wait();~t3()~+~f34()~+~f23()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~h4(\_)~+~f45(\_)~+~f34(\_)~$\Rightarrow$~wait();~t4()~+~f45()~+~f34()~\},}{\scriptsize \par}

\textcolor{blue}{\scriptsize{}~~go\{~case~h5(\_)~+~f51(\_)~+~f45(\_)~$\Rightarrow$~wait();~t5()~+~f51()~+~f45()~\}}{\scriptsize \par}
...
\textcolor{blue}{\scriptsize{}~~go~\{~case~b(x)~$\Rightarrow$~...~\})}{\scriptsize \par}
