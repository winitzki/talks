...
\end{itemize}
\item Implement anything in 10 lines of code
...
\begin{itemize}
\item \vspace{-0.2cm}
Some molecules are declared as ``distributed'', of type \texttt{\textcolor{blue}{\scriptsize{}DM{[}T{]}}}{\scriptsize\par}
\item No other new language constructions are necessary!
\begin{itemize}
\item early prototype in progress, as extension of \texttt{Chymyst}
\end{itemize}
\end{itemize}
A simple implementation of map/reduce in DCM: 15 LOC
\begin{lyxcode}
