...
\textcolor{blue}{\scriptsize{}val~d~=~m{[}Int{]}}{\scriptsize\par}
...
\textcolor{blue}{\scriptsize{}~~go~\{~case~c(x)~$\Rightarrow$~d(x~{*}~2)~\},}\textcolor{gray}{\scriptsize{}~~//~``map''}\textcolor{blue}{\scriptsize{}~}{\scriptsize\par}
...
\textcolor{blue}{\scriptsize{}res((3,~Nil))}{\scriptsize\par}

\textcolor{blue}{\scriptsize{}fetch()}\textcolor{gray}{\footnotesize{}~//~This~returned~Seq(4,~6,~2)~in~one~test.}{\footnotesize\par}
\end{lyxcode}
~\\
...
\begin{itemize}
\item Blocking molecules with time-outs
...
\begin{lyxcode}
\textcolor{blue}{\scriptsize{}val~c~=~dm{[}Int{]}}\textcolor{gray}{\scriptsize{}~//~distributed}\textcolor{blue}{\scriptsize{}~}{\scriptsize\par}

\textcolor{blue}{\scriptsize{}val~d~=~dm{[}Int{]}}\textcolor{gray}{\scriptsize{}~//~distributed}{\scriptsize\par}
...
\textcolor{blue}{\scriptsize{}~~res((3,~Nil))~;~fetch()}{\scriptsize\par}
...
\begin{itemize}
\item All DCM peers are equal (no master/worker)
\end{itemize}
\end{frame}
